...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-outline-secondary" href="/results?q=${query}">Back to Results</a>
    </div>
    ...
    <c:if test="${empty error and not empty document}">
        <div class="card shadow-sm">
            <div class="card-body">
                <h2 class="h5">${document.filename}</h2>
                <p class="text-muted mb-3">Document ID: <code>${document.id}</code></p>
